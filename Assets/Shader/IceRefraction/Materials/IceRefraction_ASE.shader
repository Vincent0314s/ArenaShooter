...
Shader "Vincent/IceRefraction_ASE"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_NormalMap("Normal Map", 2D) = "white" {}
		_NormalTiling("Normal Tiling", Float) = 1
		_RefractionStrength("Refraction Strength", Float) = 1
		[HDR]_IceTint("Ice Tint", Color) = (0,0.8399844,1,1)
		[ASEEnd]_FresPower("Fres Power", Float) = 5
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNode23 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV23, _FresPower ) );
				...
				float2 temp_output_85_0_g1 = texCoord9;
				...
				float3 temp_output_19_40 = localCombineSamplesSharp128_g1;
				float4 fetchOpaqueVal11 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( ase_screenPosNorm + float4( ( temp_output_19_40 * _RefractionStrength ) , 0.0 ) ).xy ), 1.0 );
				
				float3 Albedo = ( fresnelNode23 + ( _IceTint * fetchOpaqueVal11 ) ).rgb;
				float3 Normal = temp_output_19_40;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
...
/*ASEBEGIN
Version=18935
0;73;1600;748;1532.966;519.9383;1.3;False;False
Node;AmplifyShaderEditor.RangedFloatNode;10;-2138.448,-44.34344;Inherit;False;Property;_NormalTiling;Normal Tiling;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;22;-1721.342,-247.4963;Inherit;True;Property;_NormalMap;Normal Map;0;0;Create;True;0;0;0;False;0;False;c3ba37d749f970a43bfd0429c48422e0;c3ba37d749f970a43bfd0429c48422e0;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-1919.448,-57.34344;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-1309.773,180.8244;Inherit;False;Property;_RefractionStrength;Refraction Strength;2;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;19;-1421.342,-92.49634;Inherit;True;Normal From Texture;-1;;1;9728ee98a55193249b513caf9a0f1676;13,149,0,147,0,143,0,141,0,139,0,151,0,137,0,153,0,159,0,157,0,155,0,135,0,108,0;4;87;SAMPLER2D;0;False;85;FLOAT2;0,0;False;74;SAMPLERSTATE;0;False;91;FLOAT;1.5;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-1075.448,-100.3434;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;13;-1180.448,-448.3434;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;14;-896.448,-177.3434;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ScreenColorNode;11;-655.448,-181.3434;Inherit;False;Global;_GrabScreen0;Grab Screen 0;2;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-684.3419,-381.4963;Inherit;False;Property;_IceTint;Ice Tint;3;1;[HDR];Create;True;0;0;0;False;0;False;0,0.8399844,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;24;-714.4669,-527.9634;Inherit;False;Property;_FresPower;Fres Power;4;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;26;-803.7313,119.2144;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-368.3419,-206.4963;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FresnelNode;23;-428.3187,-638.6517;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;25;-48.48505,-322.9443;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;27;-78.93971,125.7884;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.VertexColorNode;29;-342.1664,224.9619;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;19;87;22;0
WireConnection;19;85;9;0
WireConnection;19;74;22;1
WireConnection;15;0;19;40
WireConnection;15;1;16;0
WireConnection;14;0;13;0
WireConnection;14;1;15;0
WireConnection;11;0;14;0
WireConnection;26;0;19;40
...
WireConnection;1;6;29;4
ASEEND*/
//CHKSM=020CEAC88DF01954AF806921984C5B9591CFA6D7